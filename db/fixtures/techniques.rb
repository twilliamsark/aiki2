...
AppliedTechnique.seed(:id,
  ...
  {:id=>2, :technique_id=>3, :attack_id=>2, :stance_id=>2, :waza_id=>2, :rank_id=>4, :direction_id=>nil, :name=>"Gyaku Hanmi Kote Gaeshi", :kata_id=>nil, :format_id=>2, :attack_height_id=>nil, :on_test=>true, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"gyaku hanmi kote gaeshi gyakuhanmikotegaeshi kote gaeshi kotegaeshi katate dori katatedori gyaku hanmi gyakuhanmi opposing tachi waza tachiwaza 3rd tiado hand"},
  ...
  {:id=>13, :technique_id=>6, :attack_id=>2, :stance_id=>2, :waza_id=>2, :rank_id=>4, :direction_id=>nil, :name=>"Gyaku Hanmi Irimi Nage", :kata_id=>nil, :format_id=>2, :attack_height_id=>nil, :on_test=>true, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"gyaku hanmi irimi nage gyakuhanmiiriminage irimi nage iriminage katate dori katatedori gyaku hanmi gyakuhanmi opposing tachi waza tachiwaza 3rd tiado hand"},
  ...
  {:id=>29, :technique_id=>7, :attack_id=>2, :stance_id=>2, :waza_id=>2, :rank_id=>10, :direction_id=>3, :name=>"Zempo Gaidan Kushushi Nikkyo", :kata_id=>nil, :format_id=>2, :attack_height_id=>4, :on_test=>false, :short_description=>"", :description=>"Quick entry to Nikkyo. Zempo Gedan(Gaidan) Kushushi translates roughly to 'Forward off balance to the lower'.", :related_id=>nil, :position=>nil, :keywords=>"zempo gaidan kushushi nikkyo zempogaidankushushinikkyo nikkyo katate dori katatedori gyaku hanmi gyakuhanmi opposing ura back tachi waza tachiwaza miscellaneous tiado hand gedan lower height lowerheight"},
  {:id=>30, :technique_id=>18, :attack_id=>2, :stance_id=>3, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Ai Hanmi Udekimenage", :kata_id=>nil, :format_id=>2, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"ai hanmi udekimenage aihanmiudekimenage udekimenage katate dori katatedori ai hanmi aihanmi mirroring tachi waza tachiwaza miscellaneous tiado hand"},
  {:id=>31, :technique_id=>4, :attack_id=>3, :stance_id=>nil, :waza_id=>2, :rank_id=>6, :direction_id=>nil, :name=>"Ryote Dori Shiho Nage", :kata_id=>nil, :format_id=>2, :attack_height_id=>nil, :on_test=>true, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"ryote dori shiho nage ryotedorishihonage shiho nage shihonage ryote dori ryotedori tachi waza tachiwaza 5th tiado hand"},
  {:id=>32, :technique_id=>6, :attack_id=>10, :stance_id=>2, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Tuski Irimi Nage", :kata_id=>nil, :format_id=>9, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"tuski irimi nage tuskiiriminage irimi nage iriminage tuski gyaku hanmi gyakuhanmi opposing tachi waza tachiwaza miscellaneous oyo waza oyowaza advanced"},
  {:id=>33, :technique_id=>3, :attack_id=>10, :stance_id=>2, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Tuski Kote Gaeshi", :kata_id=>nil, :format_id=>9, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"tuski kote gaeshi tuskikotegaeshi kote gaeshi kotegaeshi tuski gyaku hanmi gyakuhanmi opposing tachi waza tachiwaza miscellaneous oyo waza oyowaza advanced"},
  {:id=>34, :technique_id=>3, :attack_id=>nil, :stance_id=>nil, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Ken ti Ken Kote Gaeshi", :kata_id=>nil, :format_id=>5, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"ken ti ken kote gaeshi kentikenkotegaeshi kote gaeshi kotegaeshi tachi waza tachiwaza miscellaneous ken ti ken kentiken sword vs sword swordvssword"},
  {:id=>35, :technique_id=>3, :attack_id=>nil, :stance_id=>nil, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Ken ti Jo Kote Gaeshi", :kata_id=>nil, :format_id=>6, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"ken ti jo kote gaeshi kentijokotegaeshi kote gaeshi kotegaeshi tachi waza tachiwaza miscellaneous ken ti jo kentijo sword vs jo swordvsjo"},
  {:id=>36, :technique_id=>3, :attack_id=>4, :stance_id=>2, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Shomen Uchi Kote Gaeshi", :kata_id=>nil, :format_id=>9, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"shomen uchi kote gaeshi shomenuchikotegaeshi kote gaeshi kotegaeshi shomen uchi shomenuchi gyaku hanmi gyakuhanmi opposing tachi waza tachiwaza miscellaneous oyo waza oyowaza advanced"},
  {:id=>37, :technique_id=>7, :attack_id=>2, :stance_id=>3, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Ai Hanmi Nikkyo", :kata_id=>nil, :format_id=>2, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"ai hanmi nikkyo aihanminikkyo nikkyo katate dori katatedori ai hanmi aihanmi mirroring tachi waza tachiwaza miscellaneous tiado hand"},
  {:id=>38, :technique_id=>7, :attack_id=>nil, :stance_id=>nil, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Ken ti Ken Nikkyo", :kata_id=>nil, :format_id=>5, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"ken ti ken nikkyo kentikennikkyo nikkyo tachi waza tachiwaza miscellaneous ken ti ken kentiken sword vs sword swordvssword"},
  {:id=>39, :technique_id=>7, :attack_id=>nil, :stance_id=>nil, :waza_id=>2, :rank_id=>10, :direction_id=>nil, :name=>"Ken ti Jo Nikkyo", :kata_id=>nil, :format_id=>6, :attack_height_id=>nil, :on_test=>false, :short_description=>"", :description=>"", :related_id=>nil, :position=>nil, :keywords=>"ken ti jo nikkyo kentijonikkyo nikkyo tachi waza tachiwaza miscellaneous ken ti jo kentijo sword vs jo swordvsjo"}
)
# End auto-generated file.
